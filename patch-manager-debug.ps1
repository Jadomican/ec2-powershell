...
if ($?) {write-Host ("`nFile downloaded successfully from " + $snap.SnapshotDownloadUrl)}
...
{
    Write-Host "`nPatchBaselineOperations not found, downloading now..."
    ...
    Write-Host "`nPatchBaselineOperations downloaded, performing patch operation..."
}
else
{
    Write-Host "`nPatchBaselineOperations found, performing patch operation..."
}
